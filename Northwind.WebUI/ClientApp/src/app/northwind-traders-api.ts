...
export interface ICategoriesClient {
    getCategoryPreview(categoryId: number): Observable<CategoryPreviewDto[]>;
}
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CategoryPreviewDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<CategoryPreviewDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetCategoryPreview(response: HttpResponseBase): Observable<CategoryPreviewDto[]> {
        ...
        return _observableOf<CategoryPreviewDto[]>(<any>null);
    }
}

export interface ICustomersClient {
    getAll(): Observable<CustomersListViewModel>;
    get(id: string | null): Observable<CustomerDetailModel>;
...
export class CustomersClient implements ICustomersClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CustomersListViewModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomersListViewModel>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CustomersListViewModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CustomersListViewModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomersListViewModel>(<any>null);
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<CustomerDetailModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface IProductsClient {
    getAll(): Observable<ProductsListViewModel>;
    get(id: number): Observable<ProductViewModel>;
...
export class ProductsClient implements IProductsClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ProductsListViewModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<ProductsListViewModel>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ProductsListViewModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ProductsListViewModel>(<any>null);
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<ProductViewModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
